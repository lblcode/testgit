...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>菜单名：</label><input id="search-name" class="wu-text" style="width:100px">
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td><input type="text" name="name" class="wu-text  easyui-validatebox"  data-options="required:true,missingMessage:'请填写菜单名'" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                	<input type="text"  id="add-icon" name="icon" class="wu-text easyui-validatebox"   data-options="required:true,missingMessage:'请录入菜单图标'" />
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            <tr>
                <td width="60" align="right">菜单名:</td>
                <td><input type="text"  id="edit-name"  name="name" class="wu-text  easyui-validatebox"  data-options="required:true,missingMessage:'请填写菜单名'" /></td>
            </tr>
            <tr>
                <td align="right">上级菜单:</td>
                <td>
            ...
            <tr>
                <td valign="top" align="right">菜单图标:</td>
                <td>
                	<input type="text"  id="edit-icon" name="icon" class="wu-text easyui-validatebox"   data-options="required:true,missingMessage:'请录入菜单图标'" />
                	<a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="selectIcon()" plain="true">选择</a>
                </td>
            </tr>
        </table>
...
<script type="text/javascript">
	...
	*/
	$('#data-datagrid').treegrid({
		...
		fit:true,
		columns:[[
			{ field:'name',title:'菜单名',width:100,sortable:true},
